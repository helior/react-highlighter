...
var Highlighter = React.createClass({displayName: "Highlighter",
  ...
  renderPlain: function(string) {
    this.count++;
    return React.createElement('span',{'key': this.count}, string);
  },
  ...
  renderHighlight: function(string) {
    this.count++;
    return React.createElement('strong',{'key': this.count, 'className': 'highlight'}, string);
  },
  ...
  render: function() {
    return React.createElement('span', React.__spread({}, this.props), this.renderElement(this.props.children))
  }
});
